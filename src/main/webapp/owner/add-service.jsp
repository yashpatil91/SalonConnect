...
<%
    ...
    if (salonIdStr == null || salonIdStr.trim().isEmpty()) {
        out.println("<h3>Salon ID missing or invalid</h3>");
        return;
    }
...
<head>
    ...
    <title>Add Service - SalonConnect</title>
...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="bg-surface-light dark:bg-surface-dark rounded-3xl shadow-xl p-8 border border-gray-100 dark:border-gray-800">
        <h1 class="text-3xl font-display font-bold text-gray-900 dark:text-white mb-2">Add Service</h1>
        <p class="text-gray-500 dark:text-gray-400 mb-6">For: <%= salonName %></p>

        
           <form action="<%= request.getContextPath() %>/owner/AddServiceServlet" method="post">
            ...
            <div>
                ...
                <input type="text" id="name" name="name" required
                       ...
                       placeholder="e.g., Haircut, Spa Treatment, Manicure"/>
            </div>
