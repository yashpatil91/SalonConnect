...
<body
	...
	<main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
		<div class="mb-12">
			<form method="get" action="services.jsp">
				<div
		...
		<section class="border-t border-gray-100 dark:border-gray-800 pt-20">
			...
			<div class="flex justify-end mb-6">
				<form method="get" action="<%=request.getRequestURI()%>">
					...
					<span class="text-sm text-gray-500 dark:text-gray-300 mr-2">
                       ...
                       shadow-sm focus:ring-2 focus:ring-primary text-sm">
			...
			<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
				...
				try {
					...
					String serviceSort = request.getParameter("serviceSort");

					if (keyword2 != null) {
						keyword2 = keyword2.trim();
					}

					String sql2 = "SELECT sv.*, s.name AS salon_name "
					        + "FROM services sv "
					...
					if ("low".equals(serviceSort)) {
					    sql2 += " ORDER BY sv.price ASC ";
					} else if ("high".equals(serviceSort)) {
				...
				<div
					...
					<!-- Button -->
					<a
						href="customer/salon-details.jsp?id=<%=salonIdForService%>&serviceId=<%=serviceId%>"
