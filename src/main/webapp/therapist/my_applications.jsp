	...
	<div class="flex h-screen overflow-hidden">
		...
		<aside
			...
			<nav
				...
				<a class="sidebar-item-active flex items-center px-4 py-3.5 rounded-lg text-sm font-bold transition-all"
...
<div class="text-center mt-20 text-gray-400 dark:text-gray-500">
    You have not applied to any salons yet.
</div>
    ...
    <div>
        <% if ("PENDING".equals(status)) { %>
            ...
            <span class="inline-block px-4 py-2 text-sm font-semibold
                         ...
                         dark:bg-primary/30 dark:text-primary
                         rounded-full">
                Pending
            </span>
